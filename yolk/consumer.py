...
from yolk.request import post, APIError, DatetimeSerializer
...
# lower to leave space for extra data that will be added later, eg. "sentAt" timestamp.
...
class Consumer(Thread):
    ...
    def __init__(self, queue, org, write_key, env, ids, appInfo, flush_at=100,
    ...
    def request(self, batch):
        ...
        def send_request():
            post(self.org, self.write_key, self.env, self.ids, self.appInfo, gzip=self.gzip,
