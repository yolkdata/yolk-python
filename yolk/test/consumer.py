...
from yolk.consumer import Consumer, MAX_MSG_SIZE
from yolk.request import APIError
...
class TestConsumer(unittest.TestCase):
    ...
    def test_flush_interval(self):
        ...
        with mock.patch('yolk.consumer.post') as mock_post:
            consumer.start()
            for i in range(0, 3):
                track = {
                    'type': 'track',
    ...
    def _test_request_retry(self, consumer,
        ...
        with mock.patch('yolk.consumer.post',
    ...
    def test_max_batch_size(self):
        ...
        with mock.patch('yolk.request._session.post',
